...
create view checkin_clean as select business_id, cast(substr(timestamps, 0, 9) as date) checkin_dates from checkin lateral view explode(split(checkin_dates, ', ')) dummy as timestamps;
